...
func (mpa *MockPoolAddressValidator) GetCnData(chain common.Chain, pk common.PubKey) string {
	return ""
}

func (mpa *MockPoolAddressValidator) UpdateCnDataOfPubKey(chain common.Chain, pk common.PubKey, cnData string) {
	return
}
