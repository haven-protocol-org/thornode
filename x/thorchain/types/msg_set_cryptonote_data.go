...
func (m *MsgSetCryptonoteData) ValidateBasic() error {
	...
	if len(m.CryptonoteData) != 128 { // 64 byte is 128 charecter as a hex string
		return cosmos.ErrUnknownRequest("Cryptonote data must be 128 char hex string (64byte)")
	}
	return nil
}
